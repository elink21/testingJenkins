      ...
      extendedEmail {
          triggers {
              failure {
                  ...
                  content("Something went wrong during the credentials rotation for Metrics Cluster, performed at (${date}). Further details can be found at ${JOB_NAME} #${BUILD_NUMBER} ${JENKINS_URL}")
