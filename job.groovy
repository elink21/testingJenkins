      ...
      extendedEmail {
          triggers {
              failure {
                  ...
                  content("Something went wrong during the credentials rotation for Metrics Cluster, performed at (${date}). Further details can be found at ${WORKSPACE} ${WORKSPACE_TMP} #${BUILD_NUMBER} ${RUN_DISPLAY_URL} ")
